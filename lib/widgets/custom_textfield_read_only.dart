...
class CustomTextFieldReadOnly extends StatefulWidget {
  ...
  @override
  CustomTextFieldReadOnlyState createState() => CustomTextFieldReadOnlyState();
}

class CustomTextFieldReadOnlyState extends State<CustomTextFieldReadOnly> {
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                width: 1,
                color: widget.underlineColor ?? grey.withOpacity(0.3),
              ),
            ),

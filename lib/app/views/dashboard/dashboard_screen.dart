...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    // post frame callback for location handling
        ...
        child: SafeArea(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(
              ...
              isSearchButtonExist: (currentPage == 0 || currentPage == 1),
              showTitle: (currentPage == 2 || currentPage == 3),
            ),
  ...
  void setPage(int pageIndex) {
    ...
    // Load data for page 1 dynamically
    if (pageIndex == 1) {
      final dashController = Get.find<DashBoardController>();
      dashController.getData(12, 1, true);
      dashController.getTopRated("20", "1", true);
      dashController.getQuickRepair("20", "1", true);
    }
  }
}
